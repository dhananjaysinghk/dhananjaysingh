...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const routes = ["", "/about", "/projects", "/blog", "/notes", "/guestbook", "/tools", "/adr", "/roadmap", "/uses", "/network", "/benchmark", "/sql", "/ratelimit", "/cache", "/storage", "/ebpf", "/crdt", "/btree", "/tracing", "/merkle", "/gossip", "/mmu", "/kafka", "/disruptor", "/contact", "/resume", "/certificates", "/status", "/privacy", "/terms"]
